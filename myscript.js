$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','Cùng làm bánh với tớ nhe','Sinh nhật thú vị là khi bụt tự làm những chiếc bánh của riêng mình nhỉ, vậy thì cùng làm thôi nè');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 6){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','Tuyệt vời đó, mở tiệm làm bánh được gòi, bỏ bánh vô lò trong 3s bởi vì Nhân có phép thuật mà, chỉ cần 3s là bánh nướng xong.');
...
$( ".oven" ).droppable({
    drop: function( event, ui ) {
        $('.stage3').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','Bánh hoàn thành rồi, thêm một vài gia vị vô nhỉ.');
    }
})
